...
public class OresAchievements {
	...
	public static void addCoreAchievements() {
		initAvhievements();
		craftMill = new Achievement("craftMill", "craftMill", 7, 3, new ItemStack(OresBase.axel), AchievementList.BUILD_BETTER_PICKAXE).registerStat();
		constructMill = new Achievement("constructMill", "constructMill", 7, 5, OresBase.windvane, craftMill).registerStat();
		grindOre = new Achievement("grindOre", "grindOre", 9, 5, new ItemStack(OresBase.smallDust, 1, EnumOreType.GOLD.meta), constructMill).registerStat();
		craftSifter = new Achievement("craftSifter", "craftSifter", 9, 7, new ItemStack(OresBase.sifter), grindOre).registerStat();
