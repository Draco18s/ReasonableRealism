...
public class WorldGenMinableSalt extends WorldGenMinable {
    private final IBlockState oreBlock;
    /** The number of blocks to generate. */
    private final int numberOfBlocks;

	public WorldGenMinableSalt(IBlockState state, int blockCount) {
                            ...
                            for (int j2 = l; j2 <= k1; ++j2)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    ...
                                    if(state.getBlock() == Blocks.DIRT || state.getBlock() == Blocks.SAND) {
                                    	IBlockState stateup = worldIn.getBlockState(blockpos.up());
