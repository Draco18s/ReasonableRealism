...
public class BlockOreFlowerDesert2 extends BlockBush implements IBlockWithMapper, IShearable {
    ...
    public List<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
        ...
        ret.add(new ItemStack(this, 1, world.getBlockState(pos).getValue(Props.DESERT_FLOWER_TYPE2).getOrdinal()));
        return ret;
    }
}
