...
public class DistanceTraveledTrigger implements ICriterionTrigger<DistanceTraveledTrigger.Instance> {
	private static final ResourceLocation ID = new ResourceLocation("hardlib", "distance_traveled");
	...
	public void trigger(ServerPlayerEntity player, float f, TravelType t) {
