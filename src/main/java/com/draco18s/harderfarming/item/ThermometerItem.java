	...
	public ThermometerItem() {
		...
		this.addPropertyOverride(new ResourceLocation("time"), new IItemPropertyGetter() {
			...
			public float call(ItemStack stack, World world, LivingEntity entityIn) {
				...
				float t = bio.getTemperature(entity.getPosition());
				...
				HardLibDate.getSeasonTemp(world, (long) (EventHandlers.getTotalWorldTime(world) + (HardLibDate.getYearLength(world) * time)));
				t += flat;
